...
options = [["A. Leopard", "B. Cheetah", "C. Tiger", "D. Kangaroo"], # all the options for 1st question
           ["A. Charles Babbage", "B. Bob Kahn", "C. Alan Turing", "D. Tim Cranner"], # all the options for 2nd question
           ...
           ["A. George Washington", "B. John Adams", "C. Thomas Jefferson", "D. James Madison"]] #all the options for 5th question

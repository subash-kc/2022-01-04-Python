#you must passed two parameters in addition to the apikey paramenter
#ts timestamp and hash(a md5 digest of the ts parameter, your private key and your public key)
